...
process.load('L1Trigger.L1TCaloLayer1.layer1CaloTowerDigis_cfi')
process.layer1CaloTowerDigis.verbose = cms.bool(True)
...
process.p = cms.Path(process.l1tCaloLayer1Digis*process.layer1CaloTowerDigis)
